                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-auto">
                            ...
                            <ul class="nav nav-tabs header-tabs">
                                <li class="nav-item" data-toggle="chart" data-target="#earningsChart"
                ...
                <div class="col-12 col-xl-8">
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive mb-0"
                             data-list='{"valueNames": ["project-project", "project-status", "project-progress", "project-date"]}'>
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <!-- Text -->
                                                    <p class="mb-0">
                                                        Create the release notes for the new pages so customers are
                                                        warned.
                                                    </p>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <!-- Text -->
                                                    <p class="mb-0">
                                                        This is an extremely long todo to show wrapping. This is an
                                                        extremely long todo to show wrapping.This is an extremely long
                                                        todo to show wrapping.
                                                    </p>
                            ...
                            <div class="card card-sm mb-0">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col">
                                                ...
                                                <textarea class="form-control form-control-flush form-control-auto"
                                                          ...
                                                          placeholder="Draft your card"></textarea>
                              ...
                              <i class="fe fe-clock"></i>
                                                    ...
                                                    <!-- Input -->
                                                    <input type="text"
                                                           class="form-control form-control-sm form-control-flush form-control-auto text-muted"
                                                           data-toggle="flatpickr" data-options='{"dateFormat": "M j"}'
                        ...
                        <div class="card-footer">
                            <div class="row align-items-center">
                                <div class="col">
                                    ...
                                    <!-- Input -->
                                    <textarea class="form-control form-control-flush form-control-auto"
                                              data-toggle="autosize" rows="1" placeholder="Create a task"></textarea>
                                ...
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <!-- Avatar -->
                                            <a href="#!" class="avatar">
                                                <img src="assets/img/files/file-2.jpg" alt="..."
                                                     class="avatar-img rounded">
                                            </a>
                                ...
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <!-- Avatar -->
                                            <a href="#!" class="avatar">
                                                <img src="assets/img/files/file-3.jpg" alt="..."
                                                     class="avatar-img rounded">
                                            </a>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <ul class="nav nav-tabs nav-tabs-sm card-header-tabs">
                                <li class="nav-item" data-toggle="chart" data-target="#trafficChart"
                                    data-trigger="click" data-action="toggle" data-dataset="0">
