            ...
            <div class="modal-dialog modal-dialog-vertical" role="document">
                <form class="modal-content" id="demoForm">
                    <div class="modal-body">
                        ...
                        <!-- Button group -->
                        <div class="btn-group-toggle d-flex mb-4" data-toggle="buttons">
                            <label :class="{'active': activeNabType == 'sidenav'}" class="btn btn-white col">
                                <input type="radio" name="navPosition" id="navPositionSidenav"
                                       @click="activeNabType = 'sidenav'"
                                       value="sidenav"> Sidenav
                            </label>
                            <label :class="{'active': activeNabType == 'topnav'}" class="btn btn-white col ml-2">
                                <input type="radio" name="navPosition" id="navPositionTopnav"
                                       @click="activeNabType = 'topnav'"
                                       value="topnav"> Topnav
                            </label>
                            <label :class="{'active': activeNabType == 'combo'}" class="btn btn-white col ml-2">
                                <input type="radio" name="navPosition" id="navPositionCombo"
                                       @click="activeNabType = 'combo'"
                                       value="combo"> Combo
                            </label>
                        </div>
                        ...
                        <div class="collapse show" id="sidebarSizeContainer">
                            ...
                            <!-- Button group -->
                            <div class="btn-group-toggle d-flex mb-4" data-toggle="buttons">
                                <label :class="{'active': activeNabSize == 'base'}" class="btn btn-white col">
                                    <input type="radio" name="sidebarSize" id="sidebarSizeBase"
                                           @click="activeNabSize = 'base'" value="base"> Fullsize
                                </label>
                                <label :class="{'active': activeNabSize == 'small'}" class="btn btn-white col ml-2">
                                    <input type="radio" name="sidebarSize" id="sidebarSizeSmall"
                                           @click="activeNabSize = 'small'" value="small"> Icons
                                </label>
                            </div>
                        ...
                        <div class="btn-group-toggle d-flex" data-toggle="buttons">
                            <label class="btn btn-white col">
                                <input type="radio" name="navColor" id="navColorDefault"
                                       @click="activeNavColor = 'default'" value="default"> Default
                            </label>
                            <label class="btn btn-white col ml-2">
                                <input type="radio" name="navColor" id="navColorInverted"
                                       @click="activeNavColor = 'inverted'" value="inverted"> Inverted
                            </label>
                            <label class="btn btn-white col ml-2">
                                <input type="radio" name="navColor" id="navColorVibrant"
                                       @click="activeNavColor = 'vibrant'" value="vibrant"> Vibrant
                            </label>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <p class="text-muted mb-0">
                                    This is a description of this task. Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit. Vestibulum magna nisi, ultrices ut pharetra eget.
                                </p>
                                        ...
                                        <div class="col ml-n2">
                                            ...
                                            <div class="comment-body">
                                                ...
                                                <p class="comment-text">
                                                    Looking good Dianna! I like the image grid on the left, but it feels
                                                    like a lot to process and doesn't really <em>show</em> me what the
                                                    product does? I think using a short looping video or something
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col ml-n2">
                                            ...
                                            <div class="comment-body">
                                                ...
                                                <!-- Text -->
                                                <p class="comment-text">
                                                    Any chance you're going to link the grid up to a public gallery of
                                                    sites built with Launchday?
                                                </p>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <!-- Subtitle -->
                                <textarea class="form-control form-control-flush form-control-auto"
                                          data-toggle="autosize" rows="1" placeholder="Add a description..."></textarea>
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <div class="avatar">
                                                        <img class="avatar-img rounded"
                                                             src="data:image/svg+xml,%3csvg3c/svg%3e" alt="..."
                                                             data-dz-thumbnail>
                                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col ml-n2">
                                        ...
                                        <!-- Form -->
                                        <form class="mt-1">
                                            <textarea class="form-control form-control-flush" data-toggle="autosize"
...
<script>
const setting = require('@/services/SiteSetting').default
export default {
    name: "SlideBarRight",
    data() {
        return {
            ...
            activeNavColor: setting.getSetting('dashkitNavColor')
        }
    },
    methods: {
        changeTheme(darken = true, mode = 'dark') {
            document.querySelector('body').style.display = 'none';

            if (darken) {
                document.querySelector('#stylesheetDark').removeAttribute('disabled');
                document.querySelector('#stylesheetLight').setAttribute('disabled', 'true');
            } else {
                document.querySelector('#stylesheetLight').removeAttribute('disabled');
                document.querySelector('#stylesheetDark').setAttribute('disabled', 'true');
            }

            setting.setSetting('dashkitColorScheme', mode)
    ...
    watch: {
        activeNabType(newVal, oldVal) {
            if (newVal != oldVal) {
                this.$parent.activeNabType = newVal;
                setting.setSetting('dashkitNavPosition', newVal);
            }
        },
        activeNabSize(newVal, oldVal) {
            if (newVal != oldVal) {
                this.$parent.activeNabSize = newVal;
                setting.setSetting('dashkitSidebarSize', newVal);
            }
        },
        activeNavColor(newVal, oldVal) {
            if (newVal != oldVal) {
                setting.setSetting('dashkitNavColor', newVal);
                this.$parent.activeNavColor = setting.navColors[newVal];
            }
        }
    }
}
