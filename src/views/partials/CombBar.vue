                                ...
                                <a class="list-group-item" href="profile-posts.html">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col ml-n2">
                                            ...
                                            <!-- Status -->
                                            <p class="text-body small mb-0"><span class="text-success">●</span>
                                                Online</p>
                                ...
                                <a class="list-group-item" href="profile-posts.html">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col ml-n2">
                                            ...
                                            <!-- Status -->
                                            <p class="text-body small mb-0"><span class="text-danger">●</span>
                                                Offline</p>
                                ...
                                <a class="list-group-item text-reset" href="#!">
                                    <div class="row">
                                        ...
                                        <div class="col ml-n2">
                                            ...
                                            <!-- Content -->
                                            <div class="small"><strong>Daniela Dewitt</strong> subscribed to
                                                you.
                                            </div>
                                ...
                                <a class="list-group-item text-reset" href="#!">
                                    <div class="row">
                                        ...
                                        <div class="col ml-n2">
                                            ...
                                            <!-- Content -->
                                            <div class="small"><strong>Grace Gross</strong> subscribed to you.
                                            </div>
