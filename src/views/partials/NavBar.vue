<template>
    <div>
        ...
        <nav class="navbar navbar-vertical fixed-left navbar-expand-md "
             v-if="(activeNabType === 'sidenav' || activeNabType === 'combo') && activeNabSize != 'small'" id="sidebar">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="sidebarCollapse">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            ...
                            <div class="collapse show" id="sidebarDashboards">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <router-link to="project-management" class="nav-link ">
                                            Project Management
                                        </router-link>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="sidebarPages">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarProject" class="nav-link" data-toggle="collapse" role="button"
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarTeam" class="nav-link" data-toggle="collapse" role="button"
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarFeed" class="nav-link" data-toggle="collapse" role="button"
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarAccount" class="nav-link" data-toggle="collapse" role="button"
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarCrm" class="nav-link" data-toggle="collapse" role="button"
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#sidebarAuth" data-toggle="collapse" role="button"
                    ...
                    <ul class="navbar-nav mb-md-4">
                        <li class="nav-item">
                            <a class="nav-link" href="#sidebarBasics" data-toggle="collapse" role="button"
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="docs/changelog.html">
                                <i class="fe fe-git-branch"></i> Changelog <span class="badge badge-primary ml-auto">v1.6.3</span>
                            </a>
                        </li>
                    </ul>
        ...
        <nav class="navbar navbar-vertical navbar-vertical-sm fixed-left navbar-expand-md "
             v-if="(activeNabType === 'sidenav' || activeNabType === 'combo') && activeNabSize == 'small'"
             id="sidebarSmall">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="sidebarSmallCollapse">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropright">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="sidebarSmallDashboards">
                                ...
                                <li>
                                    <router-link to="/" class="dropdown-item active">
                                        Default
                                    </router-link>
                                </li>
                                <li>
                                    <router-link to="project-management" class="dropdown-item ">
                                        Project Management
                                    </router-link>
                                </li>
                                <li>
                        ...
                        <li class="nav-item dropright">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="sidebarSmallPages">
                                ...
                                <li class="dropright">
                                    <a class="dropdown-item dropdown-toggle " href="#" id="sidebarSmallProfile"
                                ...
                                <li class="dropright">
                                    <a class="dropdown-item dropdown-toggle " href="#" id="sidebarSmallProject"
                                       role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Project
                                    </a>
                                ...
                                <li class="dropright">
                                    <a class="dropdown-item dropdown-toggle " href="#" id="sidebarSmallTeam"
                                       role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Team
                                    </a>
                                ...
                                <li class="dropright">
                                    <a class="dropdown-item dropdown-toggle " href="#" id="sidebarSmallFeed"
                                       role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Feed
                                    </a>
                                ...
                                <li class="dropright">
                                    <a class="dropdown-item dropdown-toggle " href="#" id="sidebarSmallAccount"
                                       role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Account
                                    </a>
                                ...
                                <li class="dropright">
                                    <a class="dropdown-item dropdown-toggle " href="#" id="sidebarSmallCrm"
                                       role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        CRM
                                    </a>
                        ...
                        <li class="nav-item dropright">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="sidebarSmallAuth">
                                ...
                                <li class="dropright">
                                    <a class="dropdown-item dropdown-toggle" href="#" id="sidebarSmallSignIn"
                                       role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Sign in
                                    </a>
                                ...
                                <li class="dropright">
                                    <a class="dropdown-item dropdown-toggle" href="#" id="sidebarSmallSignUp"
                                       role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Sign up
                                    </a>
                                ...
                                <li class="dropright">
                                    <a class="dropdown-item dropdown-toggle" href="#" id="sidebarSmallPassword"
                                       role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Password reset
                                    </a>
                                ...
                                <li class="dropright">
                                    <a class="dropdown-item dropdown-toggle" href="#" id="sidebarSmallError"
                                       role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Error
                                    </a>
                    ...
                    <ul class="navbar-nav mb-md-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="docs/components.html" data-toggle="tooltip"
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="docs/changelog.html" data-toggle="tooltip" data-placement="right"
                               ...
                               title="Changelog">
                                ...
                                class="badge badge-primary ml-auto d-md-none">v1.6.3</span>
                            </a>
                        </li>
                    </ul>
        ...
        <nav class="navbar navbar-expand-lg "
             :class="activeNavColor"
             v-if="activeNabType === 'topnav'" id="topnav">
            <div class="container">
                ...
                <form class="form-inline mr-4 d-none d-lg-flex">
                    <div class="input-group input-group-rounded input-group-merge" data-list='{"valueNames": ["name"]}'>
                        ...
                        <!-- Input -->
                        <input type="search" class="form-control form-control-prepended  dropdown-toggle list-search"
              ...
              <span class="icon active">
                                    ...
                                    <a class="list-group-item text-reset" href="#!">
                                        <div class="row">
                                            ...
                                            <div class="col ml-n2">
                                                ...
                                                <!-- Content -->
                                                <div class="small">
                                                    <strong>Miyah Myles</strong> shared your post with Ryu Duke, Glen
                                                    Rouse, and 3 others.
                                                </div>
                ...
                <div class="collapse navbar-collapse mr-lg-auto order-lg-first" id="navbar">
                    ...
                    <!-- Form -->
                    <form class="mt-4 mb-3 d-md-none">
                        <input type="search" class="form-control form-control-rounded" placeholder="Search"
                               aria-label="Search">
                    </form>
                    ...
                    <ul class="navbar-nav mr-lg-auto">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="topnavDashboards">
                                <li>
                                    <router-link class="dropdown-item active" to="/">
                                        Default
                                    </router-link>
                                </li>
                                <li>
                                    <router-link class="dropdown-item " to="project-management">
                                        Project Management
                                    </router-link>
                                </li>
                                <li>
